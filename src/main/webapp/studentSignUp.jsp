...
<body>
	...
	<div class="center">
		<h1 style="color:white">Student Sign Up</h1>
		<form action="./studentsignup">
			<div class="txt_field">
				<input type="text" name="id" required> <span></span> <label>Student
					ID</label>
			</div>
			<div class="txt_field">
			...
			%>
			<div class="form-text alert alert-success" role="alert">
				Registered successfully with username
				<%=username%>
				<a href="./studentLogin.jsp">click to Login</a>
			</div>
			<%
			//}
			}
